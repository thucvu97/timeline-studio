...
## 📅 Обновлено: 25 июня 2025 (v0.26.0 - ПРОГРЕСС ПО ВСЕМ НАПРАВЛЕНИЯМ, общая готовность 76.2%)
...
### Расчет прогресса:
- **Простой прогресс**: 47.7 / 61 модуль = 78.2%
- **Взвешенный прогресс**: 285.9 / 375 весовых единиц = **76.2%** 
- **Alpha прогресс**: 289.0 / 350 = **82.6%** (без сложных модулей)
