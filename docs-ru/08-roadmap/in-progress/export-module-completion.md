...
### 7. Дополнительные функции ✅ Основные завершены
...
- `src/features/export/components/export-dialog.tsx` - новый унифицированный диалог ✅
...
- `src/features/export/hooks/use-export.ts` - основная логика ✅
- `src/features/export/hooks/use-social-export.ts` - логика соцсетей ✅
- `src/features/export/types/export.ts` - типы для всех функций ✅
...
### UI компоненты
- ✅ Создан новый ExportDialog с пресетами платформ
- ✅ Реализованы LocalExportTab, SocialExportTab, AdvancedExportTab
...
- ✅ Новый унифицированный ExportDialog с табами
...
- Новым унифицированным UI с табами пресетов
- Пакетным экспортом и экспортом секций (для 100%)
