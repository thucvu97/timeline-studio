...
- 🔄 Фаза 2: Разбиение больших файлов (в процессе - 75%)
  - ✅ Создан schema_commands.rs (290 строк) - команды работы со схемой  
  - ✅ Создан prerender_commands.rs (224 строки) - команды предрендеринга
  - ✅ Создан frame_extraction_commands.rs (294 строки) - команды извлечения кадров
  ...
  - 🔄 Остались утилитарные команды в misc.rs (кэш, GPU, FFmpeg)
