...
#### Хуки:
- `src/features/timeline/hooks/use-edit-mode.ts` - управление режимами
...
- `timeline-machine.ts` - добавлены новые события и обработчики
- `timeline.ts` - добавлены свойства offset и mediaDuration
- `factories.ts` - обновлен createTimelineClip
- `timeline-content.tsx` - интеграция системы режимов

### Реализованный функционал:
1. **8 режимов редактирования** с горячими клавишами
...
5. **Snap engine** с привязкой к сетке, клипам и маркерам
6. **Trim handles** с drag & drop функциональностью
7. **Кастомные курсоры** для каждого режима
8. **Context provider** для shared state
...
### Следующие шаги:
1. Реализовать Roll, Slip, Slide операции
2. Добавить поддержку группировки клипов
3. Реализовать J/L cuts
4. Создать систему маркеров

---

*Документ обновлен: 2025-01-07*