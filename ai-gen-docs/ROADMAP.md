...
- **Планируемые (5)**: keyboard-shortcuts(45%) + resources(40%) + voice-recording(35%) + ai-chat(30%) + export(25%) = 175%
...
├── export/            ⚠️  Требует доработки UI (25% готовности)
