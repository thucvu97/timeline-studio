...
├── docs-ru/                       # AI-сгенерированная документация для разработчиков
...
- 📚 [Карта документации](docs-ru/MAP.md) - Полный обзор документации
- 🏗️ [Руководство по архитектуре](docs-ru/ARCHITECTURE.md) - Архитектура системы
- 🧪 [Руководство по тестированию](docs-ru/testing/TESTING.md) - Стратегии тестирования
- 📡 [Справочник API](docs-ru/API.md) - Справочник команд Tauri
- 🚀 [Руководство по развертыванию](docs-ru/deployment/DEPLOYMENT.md) - Сборка и развертывание
- 🛣️ [Дорожная карта](docs-ru/ROADMAP.md) - План развития проекта
