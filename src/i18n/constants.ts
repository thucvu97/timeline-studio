// Типы для языков
export type LanguageCode = "ru" | "en" | "es" | "fr" | "de" | "pt" | "zh" | "ja"

// Список поддерживаемых языков
export const SUPPORTED_LANGUAGES: LanguageCode[] = ["ru", "en", "es", "fr", "de", "pt", "zh", "ja"]
...
export function formatDateByLanguage(
  ...
  // Опции по умолчанию
  const { includeYear = true, longFormat = true, addYearSuffix = language === "en" } = options
