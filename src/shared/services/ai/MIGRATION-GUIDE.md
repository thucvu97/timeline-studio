...
Это руководство поможет мигрировать существующий код на новую архитектуру shared AI services.
...
### Преимущества:
- Устранено дублирование кода (редукция ~45%)
- Решены циклические зависимости
...
## 🔧 Шаг 2: Миграция singleton паттерна на DI
...
## 🎯 Шаг 3: Использование unified AI service
...
## 🖼️ Шаг 5: Миграция Vision анализа
...
- [ ] Заменить singleton паттерны на DI
- [ ] Мигрировать на UnifiedAIService
- [ ] Обновить FFmpeg анализ
- [ ] Обновить Vision анализ  
- [ ] Добавить AIServicesProvider в React
...
3. **Lazy loading**: Сервисы загружаются по требованию для оптимизации
4. **Fallback**: UnifiedAIService автоматически переключается между провайдерами при ошибках
...
```typescript
// Используйте type assertions где нужно
...
- [API Reference](./README.md) - документация по API
