...
const { fileExists, validateFileIntegrity, generateAlternativePaths, convertFromSavedMediaFile, getExtensionsForFile } = await import('./saved-media-utils')
...
describe('MediaRestorationService', () => {
  ...
  describe('restoreFile', () => {
    ...
    it('должен обрабатывать ошибки', async () => {
      ...
      await expect(MediaRestorationService.restoreFile(mockSavedFile, '/project/dir'))
