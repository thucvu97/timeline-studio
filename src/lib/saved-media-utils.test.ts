...
describe('saved-media-utils', () => {
  ...
  describe('generateFileId', () => {
    ...
    it('должен генерировать разные ID для разных файлов', () => {
      const id1 = generateFileId('/path/to/file1.mp4', { size: 1024, lastModified: 1234567890 })
      const id2 = generateFileId('/path/to/file2.mp4', { size: 2048, lastModified: 1234567891 })
  ...
  describe('fileExists', () => {
    it('должен возвращать true для существующего файла', async () => {
      ...
      expect(mockInvoke).toHaveBeenCalledWith('file_exists', { path: '/path/to/existing/file.mp4' })
    })
  ...
  describe('getFileStats', () => {
    it('должен возвращать статистику файла', async () => {
      ...
      expect(mockInvoke).toHaveBeenCalledWith('get_file_stats', { path: '/path/to/file.mp4' })
    })
  ...
  describe('getAbsolutePath', () => {
    it('должен возвращать абсолютный путь', async () => {
      ...
      expect(mockInvoke).toHaveBeenCalledWith('get_absolute_path', { path: './relative/file.mp4' })
    })
  ...
  describe('validateFileIntegrity', () => {
    it('должен валидировать корректный файл', async () => {
      ...
      mockInvoke.mockResolvedValueOnce({ size: 1024, lastModified: 1234567890 }) // get_file_stats
