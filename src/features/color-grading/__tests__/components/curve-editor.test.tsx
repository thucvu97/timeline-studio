...
describe("CurveEditor", () => {
  ...
  it("should render curve editor", () => {
    const { container } = render(
      <CurveEditor points={defaultPoints} onPointsChange={mockOnPointsChange} />
    )
  ...
  it("should apply custom color", () => {
    const { container } = render(
      <CurveEditor points={defaultPoints} onPointsChange={mockOnPointsChange} color="red" />
    )
  ...
  it("should add new point on svg click", () => {
    ...
    expect(mockOnPointsChange).toHaveBeenCalledWith([
      ...defaultPoints,
      expect.objectContaining({ x: 128, y: 128 }),
    ])
  })
  ...
  it("should delete point on double click", () => {
    ...
    const { container } = render(
      <CurveEditor points={threePoints} onPointsChange={mockOnPointsChange} />
    )
  ...
  it("should sort points by x coordinate for curve generation", () => {
    ...
    const { container } = render(
      <CurveEditor points={unsortedPoints} onPointsChange={mockOnPointsChange} />
    )
  ...
  it("should handle empty points array", () => {
    const { container } = render(
      <CurveEditor points={[]} onPointsChange={mockOnPointsChange} />
    )
