...
export const DEFAULT_SHORTCUTS: ShortcutDefinition[] = [
  ...
  createMacShortcut(
    ...
    "view",
    "⌘B",
    "Переключить видимость панели браузера"
  ),
  createMacShortcut(
    "toggle-timeline",
    ...
    "view",
    "⌘T",
    "Переключить видимость таймлайна"
  ),
  createMacShortcut(
    "toggle-options",
    ...
    "view",
    "⌘O",
    "Переключить видимость панели опций"
  ),
  createMacShortcut(
    "toggle-fullscreen",
    "Полноэкранный режим",
  ...
  createMacShortcut(
    ...
    "timeline",
    "S",
    "Разрезать клип в позиции курсора"
  ),
  createMacShortcut(
    "delete-clip",
    "Удалить клип",
  ...
  createMacShortcut(
    ...
    "tools",
    "B",
    "Активировать инструмент разрезания"
  ),
  createMacShortcut(
    "zoom-tool",
    "Инструмент масштаб",
    "tools",
    "Z",
    "Активировать инструмент масштабирования"
  ),
  createMacShortcut(
    "hand-tool",
    "Инструмент рука",
    "tools",
    "H",
    "Активировать инструмент перемещения"
  ),
  ...
  createMacShortcut(
    ...
    "export",
    "⇧⌘E",
    "Экспортировать с последними настройками"
  ),
...
export const SHORTCUTS_BY_CATEGORY = DEFAULT_SHORTCUTS.reduce((acc, shortcut) => {
