...
export function subtitleStyleToCSS(style: SubtitleStyle): React.CSSProperties {
  ...
  if (style.style.fontSize)
    cssStyle.fontSize = typeof style.style.fontSize === "number" ? `${style.style.fontSize}px` : style.style.fontSize
  ...
  if (style.style.letterSpacing) {
    cssStyle.letterSpacing =
      typeof style.style.letterSpacing === "number" ? `${style.style.letterSpacing}px` : style.style.letterSpacing
  }
  ...
  if (style.style.padding) {
    cssStyle.padding = typeof style.style.padding === "number" ? `${style.style.padding}px` : style.style.padding
  }
  if (style.style.borderRadius) {
    cssStyle.borderRadius =
      typeof style.style.borderRadius === "number" ? `${style.style.borderRadius}px` : style.style.borderRadius
  }
