...
describe("filter-processor", () => {
  ...
  describe("groupFilters", () => {
    ...
    it("should handle filters without category", () => {
      const filtersWithoutCategory = [{ ...filters[0], category: undefined as any }]
    ...
    it("should handle filters without complexity", () => {
      const filtersWithoutComplexity = [{ ...filters[0], complexity: undefined as any }]
    ...
    it("should handle filters with empty tags", () => {
      const filtersWithEmptyTags = [{ ...filters[0], tags: [] }] as VideoFilter[]
  ...
  describe("sortFilters", () => {
    ...
    it("should handle missing complexity", () => {
      const filtersWithMissingComplexity = [{ ...filters[0], complexity: undefined }, filters[1]] as VideoFilter[]
    ...
    it("should handle missing category", () => {
      const filtersWithMissingCategory = [{ ...filters[0], category: undefined }, filters[1]] as VideoFilter[]
