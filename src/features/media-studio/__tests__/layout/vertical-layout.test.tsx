...
describe("VerticalLayout", () => {
  ...
  it("should render with browser visible", () => {
    ...
    expect(screen.getByTestId("resizable-panel-group-vertical-main-layout")).toBeInTheDocument()
    expect(screen.getByTestId("resizable-panel-group-vertical-main-layout")).toHaveAttribute(
      "data-direction",
      "horizontal",
    )
