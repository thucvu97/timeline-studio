    ...
    <div className="flex flex-col gap-2">
      <div className="flex justify-around gap-2">
        <DefaultLayout
          ...
          onClick={() => {
            console.log(
              "DefaultLayout clicked, calling onLayoutChange with 'default'",
            )
        ...
        <OptionsLayout
          ...
          onClick={() => {
            console.log(
              "OptionsLayout clicked, calling onLayoutChange with 'options'",
            )
      ...
      <div className="flex justify-around gap-2">
        <VerticalLayout
          ...
          onClick={() => {
            console.log(
              "VerticalLayout clicked, calling onLayoutChange with 'vertical'",
            )
        ...
        <DualLayout
          ...
          onClick={() => {
            console.log(
              "DualLayout clicked, hasExternalDisplay:",
              hasExternalDisplay,
            )
