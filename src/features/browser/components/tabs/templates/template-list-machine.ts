...
export const MAX_TEMPLATE_PREVIEW_SIZE = TEMPLATE_PREVIEW_SIZES[TEMPLATE_PREVIEW_SIZES.length - 1]
...
export const getSavedTemplateSize = (): number => {
  ...
  try {
    ...
    console.error("[TemplatePreviewSize] Error reading from localStorage:", error)
  }
...
export const getSavedFavoritesState = (): boolean => {
  ...
  try {
    ...
    console.error("[TemplateFavorites] Error reading from localStorage:", error)
  }
