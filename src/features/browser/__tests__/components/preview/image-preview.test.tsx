...
vi.mock("lucide-react", () => ({
  ...
  Star: ({ className, strokeWidth }: any) => (
    <div data-testid="lucide-star" data-class-name={className} data-stroke-width={strokeWidth}>
      Star Icon
    </div>
  ),
  Plus: ({ className, strokeWidth }: any) => (
    <div data-testid="lucide-plus" data-class-name={className} data-stroke-width={strokeWidth}>
      Plus Icon
    </div>
  ),
}))
