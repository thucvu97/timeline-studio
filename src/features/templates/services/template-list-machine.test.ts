...
describe("TemplateListMachine", () => {
  ...
  it("should save and load template size from localStorage", () => {
    ...
    expect(localStorageMock.setItem).toHaveBeenCalledWith("timeline-template-preview-size", "200")
    ...
    expect(localStorageMock.getItem).toHaveBeenCalledWith("timeline-template-preview-size")
  ...
  it("should save and load favorites state from localStorage", () => {
    ...
    expect(localStorageMock.setItem).toHaveBeenCalledWith("timeline-template-favorites-only", "true")
    ...
    expect(localStorageMock.getItem).toHaveBeenCalledWith("timeline-template-favorites-only")
