...
describe("TemplatePreview", () => {
  ...
  it("should calculate dimensions correctly for landscape template", () => {
    renderWithTemplates(
      <TemplatePreview template={mockTemplate} onClick={mockOnClick} size={mockSize} dimensions={[1920, 1080]} />,
    )
  ...
  it("should calculate dimensions correctly for portrait template", () => {
    renderWithTemplates(
      <TemplatePreview template={mockTemplate} onClick={mockOnClick} size={mockSize} dimensions={[1080, 1920]} />,
    )
