          ...
          onFaceDetected: (faces) => {
            ...
            faces.forEach(async (face) => {
              if (face.embedding && personService.current) {
                const results =
                  await personService.current.searchPersonsByEmbedding(
                    face.embedding,
                    0.7,
                    1,
                  );
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>
              Продвинутое распознавание лиц в реальном времени
            </CardDescription>
          </div>
          <Button
                ...
                {detectedFaces.map((face, index) => (
                  ...
                  >
                      ...
                      <div>
                        ...
                        {face.advancedAttributes && (
                          <div className="text-sm text-muted-foreground">
                            ...
                            {face.advancedAttributes.gender &&
                              `, ${face.advancedAttributes.gender}`}
                            {face.advancedAttributes.emotion &&
                              ` • ${face.advancedAttributes.emotion}`}
                          </div>
                        )}
                      </div>
                    ...
                    <div className="flex items-center gap-2">
                      <Badge
                        variant={
                          face.confidence > 0.8 ? "default" : "secondary"
                        }
                      >
                        {(face.confidence * 100).toFixed(0)}%
                      </Badge>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                ...
                <Slider
                  ...
                  onValueChange={([value]) =>
                    updateConfig({ qualityThreshold: value })
                  }
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    updateConfig({ detectEmotions: checked })
                  }
                />
              </div>

              <div className="flex items-center justify-between">
                <Label htmlFor="age-gender-switch">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    updateConfig({ detectAgeGender: checked })
                  }
                />
              </div>

              <div className="flex items-center justify-between">
                <Label htmlFor="landmarks-switch">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    updateConfig({ detectLandmarks: checked })
                  }
                />
              </div>
            </div>
