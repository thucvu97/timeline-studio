...
export function AngleViewer({
  ...
  // Обработчик клика по углу
  const handleAngleClick = useCallback((angle: MulticamAngle, index: number) => {
          ...
          >
            ...
            <div className="aspect-video relative">
              ...
              >
                ...
                {angle.mediaPath && (
                  <source src={`media-loader://${angle.mediaPath}`} type="video/mp4" />
                )}
                {angle.preview && (
                  <source src={angle.preview} type="video/mp4" />
                )}
              </video>
            ...
            {showLabels && (
              <div className="absolute top-2 left-2">
                <Badge variant={angle.isActive ? "default" : "secondary"}>
                  {angle.name}
                </Badge>
              </div>
            )}
