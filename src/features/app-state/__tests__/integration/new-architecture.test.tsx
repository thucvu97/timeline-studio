...
import { PlayerProvider } from '../../../video-player/services/player-provider'
import { useTimeline } from '../../../timeline/hooks/use-timeline'
import { usePlayer } from '../../../video-player/services/player-provider'
  ...
  return (
    <div>
      ...
      <div data-testid="project-name">
        {timeline.project?.metadata.name || 'No Project'}
      </div>
      ...
      <div data-testid="timeline-scale">
        {timeline.timeScale}
      </div>
      <button 
        data-testid="set-scale" 
        onClick={() => timeline.setTimeScale(2)}
      >
        Set Scale
      </button>
    </div>
