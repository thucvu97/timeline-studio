...
beforeEach(() => {
  ...
  mockState.matches = vi.fn((state: string) => state === "closed")
})
...
describe("ModalProvider", () => {
  ...
  it("should provide context with modal data when available", () => {
    ...
    mockState.context = {
      modalType: "user-settings" as ModalType,
      modalData: { dialogClass: "test-class", someKey: "someValue" } as ModalData,
      previousModal: null as ModalType | null,
    }
