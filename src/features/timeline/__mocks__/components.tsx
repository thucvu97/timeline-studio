...
export const MockTimeline = vi.fn(({ 
  onReady, 
  onTimeUpdate,
  onSelectionChange,
  ...props 
...
export const MockTimelineScale = vi.fn(({ 
  duration,
  scale,
  onScaleChange,
  ...props 
...
export const MockTimelineContent = vi.fn(({ 
  children,
  onScroll,
  ...props 
}: any) => (
  <div 
    data-testid="mock-timeline-content"
...
export const MockTimelineTopPanel = vi.fn(({ 
  onAddTrack,
  onUndo,
  onRedo,
  canUndo,
