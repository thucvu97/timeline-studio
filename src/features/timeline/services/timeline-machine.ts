...
export type TimelineEvents =
  ...
  // Секции
  | { type: "ADD_SECTION"; name: string; startTime: number; duration: number; realStartTime?: Date }
  | { type: "REMOVE_SECTION"; sectionId: string }
  | { type: "UPDATE_SECTION"; sectionId: string; updates: Partial<TimelineSection> }

  // Треки
  | { type: "ADD_TRACK"; trackType: TrackType; sectionId?: string; name?: string }
  | { type: "REMOVE_TRACK"; trackId: string }
  | { type: "UPDATE_TRACK"; trackId: string; updates: Partial<TimelineTrack> }
  | { type: "REORDER_TRACKS"; trackIds: string[] }

  // Клипы
  | { type: "ADD_CLIP"; trackId: string; mediaFile: MediaFile; startTime: number; duration?: number }
  | { type: "REMOVE_CLIP"; clipId: string }
  | { type: "UPDATE_CLIP"; clipId: string; updates: Partial<TimelineClip> }
  | { type: "MOVE_CLIP"; clipId: string; newTrackId: string; newStartTime: number }
  | { type: "SPLIT_CLIP"; clipId: string; splitTime: number }
  | { type: "TRIM_CLIP"; clipId: string; newStartTime: number; newDuration: number }
