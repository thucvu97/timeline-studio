...
Шаблоны мультикамеры для split-screen.
...
#### [`export`](export/README.md) - 25% ❗ КРИТИЧНО
UI для экспорта видео. Без него приложение бесполезно!
- **Покрытие тестами**: 3.64% ❗❗

#### [`keyboard-shortcuts`](keyboard-shortcuts/README.md) - 45%
Система горячих клавиш с предустановками.
- **Покрытие тестами**: 40.0%

#### [`ai-chat`](ai-chat/README.md) - 30%
AI ассистент на базе Claude/OpenAI.
- **Покрытие тестами**: 40.0%

#### [`voice-recording`](voice-recording/README.md) - 35%
Запись голоса для озвучки.

#### [`resources`](resources/README.md) - 40%
Управление ресурсами проекта. UI компоненты отсутствуют!
...
- [Дорожная карта проекта](ai-gen-docs/ROADMAP.md)
