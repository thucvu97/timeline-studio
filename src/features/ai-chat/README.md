...
### ✅ Недавно реализовано
- **Создание новых чатов**: ✅ При нажатии "+" появляется новый элемент со спиннером согласно [ТЗ создания чатов](../../../docs-ru/08-roadmap/completed/chat-new-creation-spec.md)
- **Компонент списка чатов**: ✅ Реализован компонент ChatList с анимированным спиннером
- **Управление сессиями**: ✅ Полная поддержка создания, переключения и удаления чатов
- **Улучшенное покрытие тестами**: ✅ Добавлены комплексные тесты для всех новых функций
- **Архитектурные улучшения**: ✅ Правильная организация сервисов и типов
- **Адаптивный интерфейс чата**: ✅ Поле ввода перемещается вверх/вниз в зависимости от наличия сообщений
- **Кнопка History**: ✅ Возвращает к начальному экрану со списком чатов
- **Отображение ответа агента**: ✅ Сообщения показываются выше поля ввода во время генерации ответа
...
### Селекторы
- **Режим чата**: Dropdown с вариантами Chat/Agent
...
3. ✅ Создать компонент списка чатов (ChatList) с анимацией спиннера
4. ✅ Добавить функционал создания/удаления чатов
5. ✅ Реализовать логику переключения чатов в state machine
...
- Всего тестов: 170
- Прошедших: 158
- Пропущенных: 12 (сложные интеграционные тесты)

Улучшения покрытия:
- ClaudeService: добавлены тесты для sendRequestWithTools метода (+7 тестов)
- ChatProvider: улучшено покрытие с 62.66% до 86.66% (+4 теста)
- Архитектурные исправления: устранены циклические зависимости в типах
- Организация: перенесены AI сервисы из components в services папку
