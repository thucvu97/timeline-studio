...
// Импорты из новой структуры tools-v2
import { batchProcessingTools, executeBatchProcessingTool } from "../tools-v2/automation/batch-processing-tools"
import { browserTools, executeBrowserTool } from "../tools-v2/core/browser"
import { contentIntelligenceTools, executeContentIntelligenceTool } from "../tools-v2/analysis/content-intelligence-tools"
import { effectsFiltersTools, executeEffectsFiltersTool } from "../tools-v2/core/effects-filters-tools"
import { executeExportManagementTool, exportManagementTools } from "../tools-v2/integration/export-tools"
import { executeMultimodalAnalysisTool, multimodalAnalysisTools } from "../tools-v2/analysis/multimodal-tools"
import { executePersonIdentificationTool, personIdentificationTools } from "../tools-v2/analysis/person-identification-tools"
import { executePlatformOptimizationTool, platformOptimizationTools } from "../tools-v2/integration/platform-integration-tools"
import { executePlayerTool, playerTools } from "../tools-v2/core/player"
import { executeResourceTool, resourceTools } from "../tools-v2/core/resources"
import { executeSubtitleTool, subtitleTools } from "../tools-v2/automation/subtitle-tools"
import { executeTimelineTool, timelineTools } from "../tools-v2/core/timeline"
import { executeVideoAnalysisTool, videoAnalysisTools } from "../tools-v2/analysis/video-analysis-tools"
import { executeWhisperTool, whisperTools } from "../tools-v2/analysis/whisper-tools"
import { executeWorkflowAutomationTool, workflowAutomationTools } from "../tools-v2/automation/workflow-tools"
import type {
  AIBrowserContext,
  AIPlayerContext,
  AIResourcesContext,
