# Export Module - Модуль экспорта 🔄 65-70%

Модуль для экспорта видео проектов в различные форматы и платформы. **Локальный экспорт готов, социальные сети и экспорт секций требуют доработки.**
