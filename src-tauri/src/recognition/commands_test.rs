...
mod tests {
    ...
    use super::super::types::{BoundingBox, DetectedObject, DetectedFace, RecognitionResults};
    ...
    fn test_error_message_formatting() {
        ...
        let error = format!("Ошибка пакетной обработки YOLO для объектов: {}", "batch error");
