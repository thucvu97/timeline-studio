...
mod tests {
  ...
  fn test_effect_parameter_types_extended() {
    ...
    effect
      .parameters
      .insert("float_param".to_string(), EffectParameter::Float(1.5));
    effect
      .parameters
      .insert("int_param".to_string(), EffectParameter::Int(42));
    ...
    effect
      .parameters
      .insert("bool_param".to_string(), EffectParameter::Bool(true));
