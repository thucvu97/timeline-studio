...
impl CommandRegistry for VideoCompilerCommandRegistry {
  fn register_commands<R: Runtime>(builder: Builder<R>) -> Builder<R> {
    builder.invoke_handler(tauri::generate_handler![
      ...
      get_all_metrics_original,
      get_service_metrics_original,
      export_metrics_prometheus_original,
      reset_service_metrics_original,
      get_active_operations_count_original,
      get_error_statistics_original,
      get_slow_operations_original,
      get_service_container_metrics_original,
      // Original settings commands
      get_compiler_settings_original,
      update_compiler_settings_original,
      set_ffmpeg_path_original,
      set_parallel_jobs_original,
      set_memory_limit_original,
      set_temp_directory_original,
      set_log_level_original,
      reset_compiler_settings_original,
      get_recommended_settings_original,
      export_settings_original,
      import_settings_original,
      get_quality_presets_original,
      // Original rendering commands
      get_render_pipeline_statistics_original,
      extract_frames_for_clip_original,
      extract_frames_for_subtitles_original,
      get_ffmpeg_builder_settings_original,
      get_ffmpeg_builder_project_info_original,
      get_segment_filters_info_original,
      validate_segment_timestamps_original,
      get_frame_extraction_cache_original,
      get_clip_input_index_original,
      // Original test helpers commands
      create_test_render_cache_original,
      get_test_cache_preview_original,
      get_test_cache_metadata_original,
