...
#[cfg(test)]
mod media_real_data_tests {
  use crate::media::__tests__::test_data::media_test_data::*;
  use crate::media::metadata::extract_metadata;
  use crate::media::performance_limits::PerformanceLimits;
  ...
  async fn test_extract_metadata_from_long_audio() {
    ...
    println!("Metadata extraction took: {duration:?}");
    assert!(
      duration.as_secs() < PerformanceLimits::METADATA_EXTRACTION_LIMIT,
  ...
  async fn test_thumbnail_generation_4k_video() {
    ...
    assert!(
      duration.as_secs() < PerformanceLimits::THUMBNAIL_4K_LIMIT,
  ...
  async fn test_parallel_processing() {
    ...
    assert!(
      duration.as_secs() < (files.len() as u64 * PerformanceLimits::BATCH_PROCESSING_PER_FILE),
  ...
  async fn test_memory_usage_large_files() {
    ...
    assert!(
      duration.as_secs() < PerformanceLimits::LARGE_FILE_PROCESSING_LIMIT,
  ...
  async fn test_large_file_performance() {
    ...
    assert!(
      metadata_duration.as_secs() < PerformanceLimits::METADATA_EXTRACTION_LIMIT,
