...
pub enum AppEvent {
    ...
    // Rendering events
    RenderStarted { job_id: String, project_id: String },
    RenderProgress { job_id: String, progress: f32 },
    RenderCompleted { job_id: String, output_path: String },
    RenderFailed { job_id: String, error: String },
    
    // Media events
    MediaImported { media_id: String, path: String },
    MediaProcessed { media_id: String },
    ThumbnailGenerated { media_id: String, thumbnail_path: String },
    
    // Recognition events
    RecognitionStarted { media_id: String, model: String },
    RecognitionCompleted { media_id: String, results: serde_json::Value },
    
    // Plugin events
    PluginLoaded { plugin_id: String, version: String },
    PluginUnloaded { plugin_id: String },
    PluginEvent { plugin_id: String, event: serde_json::Value },
