...
mod tests {
    ...
    fn test_parse_oauth_callback_url() {
        ...
        let result = parse_oauth_callback_url("https://example.com/callback?code=test123&state=mystate".to_string());
    ...
    fn test_parse_oauth_callback_url_with_error() {
        ...
        let result = parse_oauth_callback_url("https://example.com/callback?error=access_denied&error_description=User%20denied%20access".to_string());
