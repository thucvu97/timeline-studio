        ...
        <div className="flex flex-col md:flex-row gap-12">
          ...
          <div className="flex-1 grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <a href="/api-docs/" className="text-sm text-gray-400 hover:text-gray-200 transition-colors">
                    Documentation
                  </a>
                </li>
                <li>
                  <a href="/blog" className="text-sm text-gray-400 hover:text-gray-200 transition-colors">
                    Blog
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="https://github.com/chatman-media/timeline-studio/issues" className="text-sm text-gray-400 hover:text-gray-200 transition-colors">
                    Submit feedback
                  </a>
                </li>
              </ul>
            ...
            {/* Social Column */}
            <div>
              <h3 className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-4">SOCIAL</h3>
              <div className="flex flex-col gap-3">
                ...
                <a
                  href="https://twitter.com/timelinestudio"
                  className="text-gray-500 hover:text-gray-300 transition-all duration-200 hover:scale-110"
                  aria-label="X"
                >
                  <svg className="w-5 h-5 filter drop-shadow-[0_0_3px_rgba(255,255,255,0.3)]" fill="currentColor" viewBox="0 0 24 24">
