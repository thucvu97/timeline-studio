              ...
              <div className="relative overflow-hidden rounded-2xl">
                ...
                <div className="relative p-8 md:p-12">
                  <p className="text-lg text-gray-300 leading-relaxed mb-6">
                    At Timeline Studio, we believe that video editing should be accessible, intuitive, and powerful. Our
                    mission is to democratize professional video creation by combining cutting-edge AI technology with a
          ...
          <div className="container mx-auto px-6 md:px-8 lg:px-12">
            ...
            >
              ...
              <p className="text-lg text-gray-300 mb-12">
                Our team combines expertise in AI, video technology, and user experience design to create tools that
                truly understand creator needs.
              </p>
          ...
          <div className="container mx-auto px-6 md:px-8 lg:px-12">
            ...
            >
              ...
              <p className="text-lg text-gray-300 mb-8">
                Whether you're a content creator, developer, or just passionate about the future of video, we'd love to
