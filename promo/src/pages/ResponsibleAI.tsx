              ...
              <div className="space-y-8 text-gray-300">
                <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-6 mb-8">
                  <p className="text-white font-medium">
                    At Timeline Studio, we are committed to developing and deploying AI technology responsibly. 
                    Our AI features are designed to empower creators while respecting privacy, promoting fairness, 
                    and ensuring transparency in how our technology works.
                  </p>
                </div>

                <div>
                  <h2 className="text-2xl font-bold text-white mb-4">1. Our AI Principles</h2>
                  <p>
                    Timeline Studio's AI development and deployment are guided by the following core principles:
                  </p>
                  <ul className="list-disc ml-6 mt-3 space-y-2">
                    <li><strong>Human-Centered Design:</strong> AI should augment human creativity, not replace it</li>
                    <li><strong>Transparency:</strong> Users should understand how AI features work and their limitations</li>
                    <li><strong>Privacy First:</strong> User data and content remain private and secure</li>
                    <li><strong>Fairness and Inclusivity:</strong> AI should work equitably for all users</li>
                    <li><strong>Safety and Reliability:</strong> AI features must be thoroughly tested and reliable</li>
                    <li><strong>User Control:</strong> Users maintain full control over AI-generated content</li>
                  </ul>
                </div>

                <div>
                  <h2 className="text-2xl font-bold text-white mb-4">2. Ethical AI Use</h2>
                  <p>
                ...
                <div>
                  ...
                  <ul className="list-disc ml-6 mt-3 space-y-2">
                    <li><strong>Local Processing:</strong> Many AI features run directly on your device</li>
                    <li><strong>No Training on User Data:</strong> We never use your content to train our AI models</li>
                    <li><strong>Temporary Processing:</strong> Cloud-processed content is deleted after completion</li>
                    <li><strong>Encrypted Transmission:</strong> All data transfers are encrypted end-to-end</li>
                    <li><strong>Data Minimization:</strong> We only process what's necessary for the requested feature</li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc ml-6 mt-3 space-y-2">
                    <li><strong>Opt-in by Default:</strong> AI features require explicit activation</li>
                    <li><strong>Disable Anytime:</strong> Turn off any AI feature in settings</li>
                    <li><strong>Review and Edit:</strong> All AI suggestions are editable</li>
                    <li><strong>Export Original:</strong> Always maintain access to unprocessed content</li>
                    <li><strong>Delete AI Data:</strong> Remove any AI-processed data on request</li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <p className="mt-4">
                    We welcome feedback and suggestions on how we can improve our responsible AI practices 
