...
├── ai-gen-docs/                      # เอกสารที่สร้างโดย AI สำหรับนักพัฒนาและเอเจนต์
...
แต่ละฟีเจอร์มีเอกสารโดยละเอียด:

- **`README.md`** - ข้อกำหนดการทำงาน สถานะความพร้อม

### 📋 เอกสารหลัก

- **`src/features/DEV-README.md`** - ภาพรวมของฟีเจอร์ทั้งหมดพร้อมความสำคัญและสถานะ
- **`README.md`** - ข้อมูลโครงการทั่วไป (ภาษาอังกฤษ)
- **`README.es.md`** - เอกสารเวอร์ชันภาษาสเปน
- **`README.fr.md`** - เอกสารเวอร์ชันภาษาฝรั่งเศส
- **`README.de.md`** - เอกสารเวอร์ชันภาษาเยอรมัน
- **`README.ru.md`** - เอกสารเวอร์ชันภาษารัสเซีย

## เอกสาร

- 📚 [แผนที่เอกสาร](ai-gen-docs/MAP.md) - ภาพรวมเอกสารที่สมบูรณ์
- 🏗️ [คู่มือสถาปัตยกรรม](ai-gen-docs/ARCHITECTURE.md) - สถาปัตยกรรมระบบ
- 🧪 [คู่มือการทดสอบ](ai-gen-docs/testing/TESTING.md) - กลยุทธ์การทดสอบ
- 📡 [การอ้างอิง API](ai-gen-docs/API.md) - การอ้างอิงคำสั่ง Tauri
- 🚀 [คู่มือการปรับใช้](ai-gen-docs/deployment/DEPLOYMENT.md) - การบิลด์และการปรับใช้
- 🛣️ [แผนงาน](ai-gen-docs/ROADMAP.md) - แผนงานการพัฒนา
