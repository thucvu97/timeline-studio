...
**1. Поддержка фильтров (ПЕРВЫЙ ПРИОРИТЕТ)**:
- [ ] Обновить `collectAllEffects` в `timeline-to-project.ts`
- [ ] Добавить маппинг параметров фильтров
- [ ] Расширить backend для обработки фильтров
- [ ] Тестирование с базовыми фильтрами (brightness, contrast)

**2. Поддержка шаблонов**:
- [ ] Добавить поле `template` в TimelineClip
- [ ] Создать типы Template в backend
- [ ] Реализовать FFmpeg композицию для layouts
- [ ] Тестирование split-screen шаблонов

**3. Поддержка стильных шаблонов**:
- [ ] Добавить `style_templates` в ProjectSchema
- [ ] Создать backend структуры для элементов
- [ ] Реализовать рендеринг текста и графики
- [ ] Тестирование intro/outro шаблонов

**4. Поддержка субтитров**:
- [ ] Добавить subtitle tracks в схему
- [ ] Реализовать стилизацию текста
- [ ] FFmpeg drawtext фильтр
...
1. **Поддержка фильтров**:
   - [ ] Добавить сбор фильтров в `timelineToProjectSchema`
...
2. **Поддержка шаблонов (Templates)**:
   - [ ] Добавить типы Template в backend схему
...
4. **Поддержка субтитров**:
   - [ ] Добавить subtitle tracks в Timeline схему
   - [ ] Стилизация субтитров (шрифт, цвет, тень)
   - [ ] Позиционирование и анимация
   - [ ] Поддержка различных форматов (SRT, ASS)
...
- [ ] Субтитры отображаются со стилями
...
### Фаза 2: Визуальные элементы (ТЕКУЩАЯ)
1. ➡️ Поддержка фильтров в компиляторе
2. Поддержка шаблонов (templates)
3. Поддержка стильных шаблонов
4. Поддержка субтитров
